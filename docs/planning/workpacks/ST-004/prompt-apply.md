# Codex APPLY Prompt — ST-004: Retroactive verification of assist-mode initiative ACs
...
- `docs/planning/initiatives/INIT-2026Q1-assist-mode.md` (MODIFY — status line only)
...
Create `docs/planning/epics/EP-002/verification-report.md` with EXACTLY this content:
...
In file `docs/planning/initiatives/INIT-2026Q1-assist-mode.md`, change line 5:
