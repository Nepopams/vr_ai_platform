# Codex APPLY Prompt — ST-031: Observability Documentation and Runbook
...
- 5 primary log types confirmed with exact schemas.
- Aggregation script at `skills/observability/scripts/aggregate_metrics.py` — confirmed output format.
- All env vars confirmed via `rg os.getenv`.
- `docs/guides/observability.md` does NOT exist — no conflict.
- Existing guide style: `docs/guides/llm-setup.md` (151 lines), `docs/guides/golden-dataset.md` (190 lines).
- Privacy guarantees in fallback_metrics and partial_trust_risk logs (NO raw user/LLM text).

## Files to Create

### 1. `docs/guides/observability.md` (NEW)
...
- `skills/observability/scripts/aggregate_metrics.py` — DO NOT CHANGE
- `graphs/core_graph.py` — DO NOT CHANGE
- `.env.example` — DO NOT CHANGE
- All test files — DO NOT CHANGE
...
- `docs/guides/observability.md` already exists (naming conflict)
